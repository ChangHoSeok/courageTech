...
public class Util {
	...
	private static final String SOCIALNO_NUMERIC_ERRCODE = "SCM0002"; // 숫자로
																		// 구성되어있지
																		// 않음
	...
	public static String getRandomString(int length) {
		char[] charaters = { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v',
	...
	/**
	 * <pre>
	 * 1. 개요 : XSS 보안사항으로 변환된 html 테그 복원
	 * </pre>
	 * 
	 * @Author	: Seok Chang Ho
	 * @Date	: 2014. 5. 9.
	 * @Method Name : convHtmlTag
	 * @param htmlStr
	 * @return
	 */
	public static String convHtmlTag(String htmlStr) {
		String resultStr = "";
		
		if (!Util.nvl(htmlStr).equals("")) {
			resultStr = htmlStr;
			resultStr = resultStr.replaceAll("&lt;", "<");
			resultStr = resultStr.replaceAll("&gt;", ">");
			resultStr = resultStr.replaceAll("&amp;", "&");
	...
	public static Object checkNull(Object inValue, Object defaultValue) {
	...
	public static boolean checkNull(Object inValue) {
		boolean result = true;
		if (inValue == null) {
			result = true;
		} else if (inValue.toString().trim().equals("")) {
			result = true;
		} else {
			result = false;
		}

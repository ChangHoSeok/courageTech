 ...
 * </pre>
 */
public class CmmUpperCdValueTag extends TagSupport {

	private static final long serialVersionUID = -8134079391182574135L;
	
	public CmmUpperCdValueTag() {
		super();
	}
	...
	public int doStartTag() throws JspException {
		try {
			this.pageContext.getOut().print(HierCodeMap.getInstance().getUpperCode(getGroupId(), getCode()));
		} catch (IOException e) {
			e.printStackTrace();
		}

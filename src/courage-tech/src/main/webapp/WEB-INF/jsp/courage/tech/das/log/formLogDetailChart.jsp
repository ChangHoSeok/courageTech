...
<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/<spring:eval expression="@systemConfig['system.js.basePath']" />/courage/tech/das/log/logDetailChart.js"></script>
...
<!--
	$jquery(document).ready(function () {
		...
		LogDetailChart.MENU_NO = "${param.menuNo }";
		
		if (url == "") {
			location.hash = "AC=/das/log/retrieveLogDetailChart.tech&VA=content_body";
		}
	});
//-->
</script>

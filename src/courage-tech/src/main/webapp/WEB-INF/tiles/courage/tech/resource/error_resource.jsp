...
<link href="${pageContext.request.contextPath}/<spring:eval expression="@systemConfig['system.css.basePath']" />/courage/tech/error.css" rel="stylesheet" type="text/css" media="screen" />
<!-- system css : end -->

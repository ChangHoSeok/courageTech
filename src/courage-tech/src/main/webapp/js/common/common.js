...
function getLoginUserEsntlId(){
	var esntlId = $jquery("#esntlId").val();
	return esntlId;
}
function getLoginUserEmplyrId(){
	var emplyrId = $jquery("#emplyrId").val();
	return emplyrId;
}

function chkRegistUser(loginId, registId){

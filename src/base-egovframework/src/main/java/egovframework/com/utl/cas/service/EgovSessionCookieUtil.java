...
public class EgovSessionCookieUtil {
	 ...
	 * @see
	 */
	public static void setCookie(HttpServletResponse response, String path, String cookieNm, String cookieVal, int minute)
...
//		cookie.setSecure(true);
	...
	public static void setCookie(HttpServletResponse response, String path, String cookieNm, String cookieVal) throws UnsupportedEncodingException {
		// 특정의 encode 방식을 사용해 캐릭터 라인을 application/x-www-form-urlencoded 형식으로 변환
		// 일반 문자열을 웹에서 통용되는 'x-www-form-urlencoded' 형식으로 변환하는 역할
		String cookieValue = URLEncoder.encode(cookieVal, "utf-8");
...
//		cookie.setSecure(true);
	 ...
	 * @see
	 */
	public static String getCookie(HttpServletRequest request, String path, String cookieNm) throws Exception {
	 ...
	 * @see
	 */
	public static void setCookie(HttpServletResponse response, String path, String cookieNm) throws UnsupportedEncodingException {
